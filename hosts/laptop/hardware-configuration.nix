# This is a placeholder hardware configuration for your laptop.
# During NixOS installation, run this command to generate the real hardware config:
# nixos-generate-config --show-hardware-config > /etc/nixos/hosts/laptop/hardware-configuration.nix
#
